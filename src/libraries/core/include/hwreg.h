...
#define HW_REG(type, reg) (((volatile uint32_t *)type##_BASE_ADDR) + (type##_##reg##_OFFSET / 4))
#define HW_REG_ARRAY(type, reg, index) ( ((volatile uint32_t *)type##_BASE_ADDR) + (type##_##reg##_OFFSET / 4) + index)
...
#define HW_REG_MB(type, bank, reg) (((volatile uint32_t*)type##bank##_BASE_ADDR) + (type##_##reg##_OFFSET/4))
